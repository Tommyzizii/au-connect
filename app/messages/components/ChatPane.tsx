...
import { Send, ImagePlus, Paperclip, Smile, MoreVertical, ArrowLeft } from "lucide-react";
        ...
        {!selectedConversationId ? (
          ...
          <Virtuoso
            ...
            itemContent={(_, m) => (
              <MessageBubble
                m={m}
                // incoming if the sender is the OTHER user
      ...
      <div className="px-4 py-3 md:px-6 border-t shrink-0">
        <div className="flex items-center bg-white border border-gray-300 rounded-full px-3 py-2 md:px-5 md:py-3 gap-2">
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0">
            ...
            <Send onClick={onSend} className="w-5 h-5 text-gray-700 cursor-pointer hover:text-gray-900" />
          </div>
        </div>
      </div>
    </div>
